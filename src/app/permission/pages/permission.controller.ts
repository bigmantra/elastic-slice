/* @ngInject */
export default    function PermissionController($state, $window, $cookies, RoleStore, PermissionStore, UserService, users) {
  var vm = this;
  ...
  function loginClick() {
    ...
    $cookies.put('uicore-user', vm.selectedUser.username);
